...
export default function HostMenuTab() {
  ...
  const popup = <ManagePopup text={"계정을 비활성화 하시겠습까?"} close={close} onClick={noneHostMode} />
      ...
      <S.Div>
        ...
        <S.Ul>
          <S.Li>
            계정관리
            <U.Ul>
              <U.Li><Link to="/Host/HostUpdatePage">프로필 수정</Link></U.Li>
          ...
          <S.Li>
            숙소관리
            <U.Ul>
              <U.Li><Link to="/Host/HostMainPage">숙소 보기</Link></U.Li>
              <U.Li><Link to="/Host/RoomRegisterPage">숙소 등록</Link></U.Li>
              <U.Li>숙소 수정</U.Li>
            </U.Ul>
          </S.Li>
        </S.Ul>
